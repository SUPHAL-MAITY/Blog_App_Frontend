    ...
    <>
      ...
      <div className="panel" style={{ marginLeft: "0px", width: "100%" }}>
        <div className="panel_card">
          <div>
            <h1 className="panel_card_title admin_title">
              Total Admins{" "}
        ...
        <div className="panel_card">
          <h1 className="panel_card_title total_title">
            Total Users{" "}
            <i
        ...
        <div className="panel_card">
          <h1 className="panel_card_title active_title">
            Total Active Users{" "}
            <i style={{ marginLeft: "5px" }} className="fa-solid fa-user"></i>{" "}
          </h1>
        ...
        <div className="panel_card">
          <h1 className="panel_card_title inactive_title">
        ...
        <div className="panel_card">
          <h1 className="panel_card_title total_title">
            Total Posts{" "}
            <i style={{ marginLeft: "5px" }} className="fa-solid fa-blog"></i>
          </h1>
