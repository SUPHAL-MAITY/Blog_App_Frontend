  ...
  const handleSearch = async () => {
    ...
    try {
      const { data } = await api.get(
        `/user/get-own-search-blogs?q=${searchItem}`
      );
      console.log(data?.data);
    ...
    <>
      <div className="users_card">
        ...
        <div className="users_search_container">
          ...
          />
          <button className="serach_btn" onClick={handleSearch}>
            Search
          </button>
        </div>
                  ...
                  return (
                    <tr key={i}>
                      ...
                      <td>
                        <span></span>
                        <i
                          onClick={() => handleBlogEdit(c._id)}
                          className="fa-solid fa-pen-to-square edit_icon i-hover"
                        ></i>
                        <i
                          onClick={() => {
                            handleDelete(c._id);
